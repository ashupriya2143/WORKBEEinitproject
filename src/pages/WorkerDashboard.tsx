...
import { MapPin, Clock, DollarSign, Star, Bell, CheckCircle, X, User, Calendar, TrendingUp } from 'lucide-react'
                    ...
                    <div key={job.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                      ...
                      <div className="flex space-x-4">
                        ...
                        <button
                          ...
                          className="flex-1 py-3 px-6 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors"
                        >
                          Accept Job
                        </button>
                      </div>
                  ...
                  activeJobs.map(job => (
                    <div key={job.id} className="border border-green-200 bg-green-50 rounded-xl p-6">
                      ...
                      <div className="bg-white p-4 rounded-lg">
                        <p className="text-green-800 font-medium">Job confirmed! Please arrive on time and contact the business if needed.</p>
                      </div>
                    </div>
                  ))
                ) : (
