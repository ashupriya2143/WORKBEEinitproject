      ...
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-slate-800 px-8 py-6 text-center">
            ...
            <p className="text-gray-300">Sign in to your WorkBee account</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <Link
                  to={userType === 'business' ? '/register-business' : '/register-worker'}
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-xs text-gray-500 space-y-1">
                <p><strong>Business:</strong> business@workbee.in / demo123</p>
                <p><strong>Worker:</strong> worker@workbee.in / demo123</p>
              </div>
            </div>
          </div>
        </div>
