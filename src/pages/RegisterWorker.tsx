...
import { User, CheckCircle, AlertCircle, Eye, EyeOff } from 'lucide-react'
...
const RegisterWorker: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create user account
      await signUp(formData.email, password, 'worker')
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              <p className="text-sm text-orange-800">
                <strong>Note:</strong> Your information is secure and will be used only for job matching with stores and shops. All workers undergo background verification before activation.
              </p>
            </div>
            ...
            >
              {isLoading ? 'Creating Account...' : 'Register as Worker'}
            </button>
